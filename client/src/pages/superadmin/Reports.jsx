          ...
          tables: [
            {
              ...
              rows: (paymentData.payments || []).map((payment, index) => ({
                "Payment ID": index + 1,
                ...
                "Approved Date": payment.approvedDate ? new Date(payment.approvedDate).toLocaleString() : "-",
                "Payment Date": payment.paymentDate ? new Date(payment.paymentDate).toLocaleString() : "-",
